        ...
        <div>
            <div className="hero ">
                <div className="hero-content gap-5 flex-col md:flex-col-reverse lg:flex-row-reverse">
                    <div className="">
                        <img src="https://i.ibb.co/fGfTMZB/monitor-1307227-1280.jpg" className=" lg:max-w-xl h-full rounded-lg shadow-2xl md:max-w-2xl " data-aos="fade-left"/>
                    </div>
                    <div className="flex-col md:max-w-2xl">
                        <div className='flex gap-3 mb-10 md:mb-3 lg:mb-11' data-aos="fade-left">
                        ...
                        <div className='flex gap-3  mb-10 md:mb-3 lg:mb-11' data-aos="fade-right">
